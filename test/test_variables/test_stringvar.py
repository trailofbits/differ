...
def getConfig() -> dict:
    configs = [{'values': ['random value', 'rv'],
                    'regex': {'pattern': 'hello [a-zA-Z0-9]{1,10}',
                    'count': 3}},
              {'values': ["black","deer","had","receive","hill","lady",
                    "one","blow","airplane","give","rod","pure",
                    "zero","am","useful","apartment","old","room",
                    "cloud","valuable","final","serve","balance","diagram",
                    "shine","loud","me","through","dog","circle",
                    "slipped","across","tube","occasionally","stopped","swing",
                    "bring","every","share","fish","tightly","feel"],
                    'regex': {'pattern': '//[a-zA-Z0-9]{1,20}//[a-zA-Z0-9]{1,20}//[a-zA-Z0-9]{1,10}',
                    'count': 20}},
                {'values': [],
                    'regex': {'pattern': '-[a-zA-Z]{1,7} -[a-zA-Z]{1,4}',
                    'count': 11}},
                {'values': [],
...
def test_stringvar2():
    ...
    for x in generatedExps:
        assert x == 'black' or \
                ...
                x == 'tightly' or \
                x == 'feel' or \
                re.match('//[a-zA-Z0-9]{1,20}//[a-zA-Z0-9]{1,20}//[a-zA-Z0-9]{1,10}', x)
